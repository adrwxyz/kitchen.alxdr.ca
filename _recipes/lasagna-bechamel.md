...
ingredients:
  - section: Meat Sauce (Bolognese)
    items:
      ...
      - "2–3 cloves garlic, minced (20g)"
      - "4–5 sprigs fresh rosemary, chopped"
      - "4–5 sprigs oregano, chopped"
      - "2 bay leaves"
      - "½ tsp fennel seeds"
      - "¼ tsp chili flakes"
      - "2 cans whole peeled tomatoes, blended"
      - "2 tablespoons tomato paste"
      - "250ml red wine (1 cup)"
      - "250ml beef stock (1 cup)"
      - "Salt and black pepper to taste"
  - section: Lasagna Sheets (choose one)
    items:
      - "12–16 homemade pasta sheets, or"
      - "12–16 fresh pasta sheets (store-bought), or"
      - "12–16 dried lasagna sheets, oven-ready (recommended), or"
