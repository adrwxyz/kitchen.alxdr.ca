...
ingredients:
  ...
  - section: Filling
    items:
      - 1 cup short grain rice, soaked then strained
      - 1 lb ground beef
      - 1 tomato, diced
  - section: Filling Seasoning
    items:
      - 7-spice
      - Sumac
      - Mild Aleppo pepper flakes
      - Dash no-salt seasoning mix
      - Salt
      - Pepper
  - section: Cooking Liquid
    items:
      ...
      - Salt
      - Pepper
      - Beef stock or broth (enough to come halfway up the pot)
instructions:
